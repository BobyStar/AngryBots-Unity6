...
public partial class HoverMovementMotor : MovementMotor
{
    ...
    public virtual void FixedUpdate()
    {
        ...
        Vector3 deltaVelocity = targetVelocity - this.GetComponent<Rigidbody>().linearVelocity;
    ...
    public virtual void OnCollisionStay(Collision collisionInfo)
    {
        ...
        {
            this.GetComponent<Rigidbody>().linearVelocity = this.GetComponent<Rigidbody>().linearVelocity + ((Vector3.up * Time.deltaTime) * 50);
        }
    }
